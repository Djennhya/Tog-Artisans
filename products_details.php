              ...
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    <img src="<?php echo htmlspecialchars($produit['img_product']); ?>" alt="<?php echo htmlspecialchars($produit['nom_product']); ?>" class="img-responsive" data-BigImgsrc="<?php echo htmlspecialchars($produit['img_product']); ?>">
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
                  <h1><?php echo htmlspecialchars($produit['nom_product']); ?></h1>
                  <div class="price-availability-block clearfix">
                    <div class="price">
                      <strong><span><?php echo htmlspecialchars($produit['prix_product']); ?> FCFA</span></strong>
                    </div>
                  </div>
                  <div class="description">
                    <p><?php echo nl2br(htmlspecialchars($produit['description_product'])); ?></p>
                  </div>
                  ...
                  <div id="myTabContent" class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="Reviews">
                      ...
                      <form action="#" class="reviews-form" role="form">
                        ...
                        <div class="form-group">
                          <label for="review">Commentaire <span class="require">*</span></label>
                          <textarea class="form-control" rows="8" id="review"></textarea>
                        </div>
                        <div class="form-group">
                          <label for="email">Évaluer</label>
