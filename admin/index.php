										...
										<div class="row">
											...
											<div class="col-7 d-flex align-items-center">
												<div class="numbers">
													...
													<h4><?php $sql = "SELECT COUNT(*) AS total FROM products";
													$result = mysqli_query($link, $sql);
													$row = mysqli_fetch_assoc($result);
										...
										<div class="row">
											...
											<div class="col-7 d-flex align-items-center">
												<div class="numbers">
													...
													<h4><?php $sql = "SELECT COUNT(*) AS total FROM category";
													$result = mysqli_query($link, $sql);
													$row = mysqli_fetch_assoc($result);
													$total_category = $row['total'];
													echo $total_category; ?></h4>
												</div>
											</div>
										</div>
									</div>
...
<!-- 							<div class="col-md-3">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title">Statistique des clients</h4>
										<p class="card-category">
										Statistique des clients par mois</p>
									</div>
									<div class="card-body">
							...
							<div class="col-md-8">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title">Nombre de produits vendus</h4>
										<p class="card-category">
										Statistique des produits vendus par mois</p>
									</div>
									<div class="card-body">
