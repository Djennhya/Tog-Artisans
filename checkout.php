                ...
                <div class="panel-heading">
                  <h2 class="panel-title">
                    <a data-toggle="collapse" data-parent="#checkout-page" href="#checkout-content" class="accordion-toggle">
                     Étape 1 : Compte &amp; Détails de facturation
                    </a>
                  </h2>
                </div>
                <div id="checkout-content" class="panel-collapse collapse in">
                  <div class="panel-body row">
                    <div class="col-md-6 col-sm-6">
                      ...
                      <p> La creation d'un compte vous permettra d'acheter plus rapidement, d'être à jour sur l'état de vos commandes, et de suivre les commandes que vous avez déjà passées. </p>
