...
<body class="ecommerce">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 additional-shop-info">
                    <ul class="list-unstyled list-inline">
                        <li><i class="fa fa-phone"></i><span>+228 96 09 73 84</span></li>
                        <!-- EMAIL -->
                        <li>
                           <i class="fa fa-envelope"></i><span>artisapp@gmail.com</span>
                        </li>
                        <!-- EMAIL -->
                        <!-- BEGIN LANGS -->
                        <li class="langs-block">
                            ...
                            <div class="langs-block-others-wrapper"><div class="langs-block-others">
                              ...
                              <a href="javascript:void(0);">Ewe</a>
                              <a href="javascript:void(0);">Kabye</a>
                            </div></div>
                        </li>
                        <!-- END LANGS -->
                    </ul>
    ...
    <div class="header">
      <div class="container">
        <a class="site-logo" href="index.php"><img src="assets/corporate/img/logos/art.png" alt="Le digital au service des mains d’or."></a>
        ...
        <div class="top-cart-block">
          <div class="top-cart-info">
            ...
            <a href="javascript:void(0);" class="top-cart-info-value">XOF</a>
          </div>
